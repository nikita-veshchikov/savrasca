...
class AvrDevice: public SimulationMember, public TraceValueRegister {
    ...
    public:
		...
		// FOR SCA leakage
        void leakOnRead(unsigned char val);
        void leakOnRead(int val);
        void leakOnWrite(unsigned char oldVal, unsigned char newVal);
